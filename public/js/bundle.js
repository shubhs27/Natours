...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var defaultCenter = [25.7617, -80.1918];
  var mapCenter = locations.length > 0 ? [locations[0].coordinates[1], locations[0].coordinates[0]] : defaultCenter;
  ...
  locations.forEach(function (loc) {
    // Create marker
    var markerLatLng = [loc.coordinates[1], loc.coordinates[0]];
    ...
    var popup = L.popup({
      ...
      closeButton: true,
      autoClose: false
    }).setContent("<p style=\"font-size: 14px; margin: 0; padding: 5px; min-width: 150px; text-align: center;\">Day ".concat(loc.day, ": ").concat(loc.description, "</p>"));
...
const VERSION = exports.VERSION = "1.8.3";
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') location.reload(true); // true- force reload from server, not browser cache
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
